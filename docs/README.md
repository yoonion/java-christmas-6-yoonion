...
### 2. 할인 기능
- [x] 총주문 금액 10,000원 이상부터 할인 이벤트 적용
...
- [x] 이벤트 기간 2023.12.01 ~ 2023.12.31

  - 평일 할인 기능
    - [x] 일요일 ~ 목요일(일,월,화,수,목)은 디저트 메뉴 1개당 2,023원 할인

  - 주말 할인 기능
    - [x] 금요일, 토요일은 메인 메뉴 1개당 2,023원 할인 
...
- [x] 총혜택 금액 구하는 기능
  ...
  - [x] 할인 후 예상 결제 금액 = 할인 전 총주문 금 - 할인 금액
